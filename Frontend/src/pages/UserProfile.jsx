...
const UserProfile = () => {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        setSuccess('');
        try {
            if (user.fullname.firstname != formData.firstname || user.fullname.lastname != formData.lastname) {
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            const res = await axios.patch(`${import.meta.env.VITE_BASE_URL}/users/change-password`, {
    ...
    return (
        <>
            <div className='fixed top-0 left-0 p-3'>
                <Link to="/home"><img className='w-10 h-10 invert rotate-180' src="/src/assets/arrow.svg" alt="" /></Link>
            </div>
                    ...
                    {editMode === 'profile' ? (
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="text-lg font-semibold capitalize">{user.fullname.firstname} {user.fullname.lastname}</div>
                            </div>
                            <div>
